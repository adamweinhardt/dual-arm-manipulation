...
if __name__ == "__main__":
    ...
    traj_figure8 = planner.figure8_complex(
        start_pose=pose_lifted, dt=dt, width=0.6, height=0.2, z_amp=0.05, duration=10.0
    )
    ...
    full_f8_sequence = planner.concatenate_trajectories(
        [traj_up, traj_figure8, traj_down]
    )
