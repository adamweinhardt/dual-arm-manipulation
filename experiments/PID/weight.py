...
if __name__ == "__main__":
    ...
    try:
        ...
        robotR.save_everything(f"experiments/PID/logs/{traj}_{version}_{box}_{weigth}_{date}_R")
        robotL.save_everything(f"experiments/PID/logs/{traj}_{version}_{box}_{weigth}_{date}_L")
